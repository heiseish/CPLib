// Bài toán
// Dùng splay tree (kiểu top-down) để thực hiện các thao tác sau trên một dãy số:
// - Thay đổi một phần tử,
// - Đảo ngược một đoạn con liên tiếp,
// - Tính tổng một đoạn con liên tiếp trên một dãy số.
// Độ phức tạp
// thời gian khởi tạo cây O(n)
// thời gian mỗi truy vấn O(logn)
// bộ nhớ O(n)
